...
var package = Package(
  ...
  targets: [
    Target(name: "libfuzzyMatch", dependencies: []),
    Target(name: "SourceKittenDaemon", dependencies: [.Target(name: "libfuzzyMatch")]),
    Target(name: "sourcekittend", dependencies: [.Target(name: "SourceKittenDaemon"), .Target(name: "libfuzzyMatch")])
  ],
